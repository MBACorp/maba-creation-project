...
export const GPU_OPTIONS = [
  { value: AUTO, label: 'Автоматически', os: 'any' },
  { value: 'lenovo-thinkpad-t14', label: 'Lenovo ThinkPad T14 — рабочий', os: 'win', model: true },
  { value: 'lenovo-thinkpad-x1', label: 'Lenovo ThinkPad X1 Carbon — бизнес', os: 'win', model: true },
  { value: 'lenovo-thinkpad-e15', label: 'Lenovo ThinkPad E15 — бюджетный', os: 'win', model: true },
  { value: 'asus-zenbook-14', label: 'ASUS Zenbook 14 — ультрабук OLED', os: 'win', model: true },
  { value: 'asus-zenbook-pro', label: 'ASUS Zenbook Pro — для работы с графикой', os: 'win', model: true },
  { value: 'asus-tuf', label: 'ASUS TUF Gaming — игровой', os: 'win', model: true },
  { value: 'hp-pavilion', label: 'HP Pavilion 15 — домашний', os: 'win', model: true },
  { value: 'hp-pavilion-amd', label: 'HP Pavilion 15 AMD — домашний', os: 'win', model: true },
  { value: 'hp-envy', label: 'HP Envy — премиальный', os: 'win', model: true },
  { value: 'dell-xps-13', label: 'Dell XPS 13 — компактный премиум', os: 'win', model: true },
  { value: 'dell-xps-15', label: 'Dell XPS 15 — мощный премиум', os: 'win', model: true },
  { value: 'dell-inspiron', label: 'Dell Inspiron 15 — офисный', os: 'win', model: true },
  { value: 'acer-aspire', label: 'Acer Aspire 5 — бюджетный', os: 'win', model: true },
  { value: 'msi-katana', label: 'MSI Katana — игровой', os: 'win', model: true },
...
export const DEVICE_SPECS: Record<string, { cores: number[]; memory: number[]; screens: string[] }> = {
  'lenovo-thinkpad-t14': { cores: [8, 12, 16], memory: [16, 32], screens: ['1920x1080', '1920x1200', '2560x1600'] },
  'lenovo-thinkpad-x1': { cores: [12, 16], memory: [16, 32], screens: ['1920x1080', '1920x1200', '2560x1600'] },
  'lenovo-thinkpad-e15': { cores: [8, 12], memory: [8, 16], screens: ['1536x864', '1920x1080'] },
  'asus-zenbook-14': { cores: [12, 16], memory: [16, 32], screens: ['1920x1080', '2560x1600', '2880x1800'] },
  'asus-zenbook-pro': { cores: [16, 24], memory: [16, 32], screens: ['1920x1080', '2560x1600', '2880x1800'] },
  'asus-tuf': { cores: [8, 12, 16], memory: [16, 32], screens: ['1920x1080', '2560x1440'] },
  'hp-pavilion': { cores: [8, 12], memory: [8, 16], screens: ['1536x864', '1920x1080'] },
  'hp-pavilion-amd': { cores: [8, 12], memory: [8, 16], screens: ['1536x864', '1920x1080'] },
  'hp-envy': { cores: [12, 16], memory: [16, 32], screens: ['1920x1080', '2560x1600', '2880x1800'] },
  'dell-xps-13': { cores: [12, 16], memory: [16, 32], screens: ['1920x1200', '2560x1600', '3456x2160'] },
  'dell-xps-15': { cores: [14, 16, 24], memory: [16, 32, 64], screens: ['1920x1200', '2560x1600', '3456x2160'] },
  'dell-inspiron': { cores: [8, 12], memory: [8, 16], screens: ['1536x864', '1920x1080'] },
  'acer-aspire': { cores: [8, 12], memory: [8, 16], screens: ['1536x864', '1920x1080'] },
  'msi-katana': { cores: [12, 16, 24], memory: [16, 32], screens: ['1920x1080', '2560x1440'] },
  'nvidia-rtx4090': { cores: [16, 24, 32], memory: [32, 64], screens: ['1920x1080', '2560x1440', '3840x2160'] },
  'nvidia-rtx4080': { cores: [16, 24], memory: [32, 64], screens: ['1920x1080', '2560x1440', '3840x2160'] },
  'nvidia-rtx4070': { cores: [12, 16], memory: [16, 32], screens: ['1920x1080', '2560x1440', '3840x2160'] },
  'nvidia-rtx4060ti': { cores: [12, 16], memory: [16, 32], screens: ['1920x1080', '2560x1440', '3840x2160'] },
  'nvidia-rtx4060': { cores: [12, 16], memory: [16, 32], screens: ['1920x1080', '2560x1440', '3840x2160'] },
  'nvidia-rtx3080': { cores: [12, 16], memory: [16, 32], screens: ['1920x1080', '2560x1440', '3840x2160'] },
  'nvidia-rtx3070': { cores: [8, 12, 16], memory: [16, 32], screens: ['1920x1080', '2560x1440', '3840x2160'] },
  'nvidia-rtx3060': { cores: [8, 12, 16], memory: [16, 32], screens: ['1920x1080', '2560x1440', '3840x2160'] },
  'nvidia-rtx2060': { cores: [6, 8, 12], memory: [16, 32], screens: ['1920x1080', '2560x1440', '3840x2160'] },
  'nvidia-gtx1660': { cores: [6, 8, 12], memory: [8, 16], screens: ['1920x1080', '2560x1440', '3840x2160'] },
  'nvidia-gtx1650': { cores: [4, 6, 8], memory: [8, 16], screens: ['1920x1080', '2560x1440', '3840x2160'] },
  'nvidia-gtx1060': { cores: [4, 6, 8], memory: [8, 16], screens: ['1920x1080', '2560x1440', '3840x2160'] },
  'nvidia-rtx4060-laptop': { cores: [12, 16], memory: [16, 32], screens: ['1366x768', '1536x864', '1600x900', '1920x1080'] },
  'nvidia-rtx4050-laptop': { cores: [8, 12, 16], memory: [16, 32], screens: ['1366x768', '1536x864', '1600x900', '1920x1080'] },
  'nvidia-rtx3050-laptop': { cores: [8, 12], memory: [16], screens: ['1366x768', '1536x864', '1600x900', '1920x1080'] },
  'amd-rx7800xt': { cores: [12, 16], memory: [32, 64], screens: ['1920x1080', '2560x1440', '3840x2160'] },
  'amd-rx7600': { cores: [8, 12], memory: [16, 32], screens: ['1920x1080', '2560x1440', '3840x2160'] },
  'amd-rx6700xt': { cores: [8, 12, 16], memory: [16, 32], screens: ['1920x1080', '2560x1440', '3840x2160'] },
  'amd-rx6600': { cores: [8, 12], memory: [16, 32], screens: ['1920x1080', '2560x1440', '3840x2160'] },
  'amd-rx580': { cores: [4, 6, 8], memory: [8, 16], screens: ['1920x1080', '2560x1440', '3840x2160'] },
  'amd-780m': { cores: [12, 16], memory: [16, 32], screens: ['1366x768', '1536x864', '1600x900', '1920x1080'] },
  'amd-vega8': { cores: [4, 8], memory: [8, 16], screens: ['1366x768', '1536x864', '1600x900', '1920x1080'] },
  'intel-arc-a750': { cores: [12, 16], memory: [16, 32], screens: ['1920x1080', '2560x1440', '3840x2160'] },
  'intel-uhd770': { cores: [8, 12, 16], memory: [16, 32], screens: ['1920x1080', '2560x1440', '3840x2160'] },
  'intel-uhd630': { cores: [4, 6, 8], memory: [8, 16], screens: ['1366x768', '1536x864', '1600x900', '1920x1080'] },
  'intel-uhd620': { cores: [4, 8], memory: [8, 16], screens: ['1366x768', '1536x864', '1600x900', '1920x1080'] },
  'intel-iris': { cores: [8, 12], memory: [8, 16], screens: ['1366x768', '1536x864', '1600x900', '1920x1080'] },
  'apple-m1': { cores: [8], memory: [8, 16], screens: ['1470x956', '1512x982'] },
  'apple-m1pro': { cores: [8, 10], memory: [16, 32], screens: ['1512x982', '1728x1117'] },
  'apple-m1max': { cores: [10], memory: [32, 64], screens: ['1512x982', '1728x1117'] },
  'apple-m2': { cores: [8], memory: [8, 16, 24], screens: ['1470x956', '1512x982'] },
  'apple-m2pro': { cores: [10, 12], memory: [16, 32], screens: ['1512x982', '1728x1117'] },
  'apple-m2-mini': { cores: [8], memory: [8, 16, 24], screens: ['1920x1080', '2560x1440'] },
  'apple-m3': { cores: [8, 11], memory: [16, 24], screens: ['1512x982', '1728x1117'] },
  'apple-m3pro': { cores: [11, 12], memory: [18, 36], screens: ['1512x982', '1728x1117'] },
  'apple-m3max': { cores: [14, 16], memory: [36, 64], screens: ['1512x982', '1728x1117'] },
  'apple-m3-imac': { cores: [8], memory: [8, 16, 24], screens: ['1920x1080', '2560x1440'] },
  'apple-m4': { cores: [10], memory: [16, 24, 32], screens: ['1512x982', '1728x1117'] },
  'apple-m4pro': { cores: [12, 14], memory: [24, 48], screens: ['1512x982', '1728x1117'] },
  'mac-intel-mbp': { cores: [4, 8], memory: [8, 16], screens: ['1512x982', '1728x1117'] },
  'mac-intel-imac': { cores: [6, 8], memory: [8, 16], screens: ['1920x1080', '2560x1440'] },
};
...
/* Экраны, которые бывают у выбранной модели: у Zenbook OLED, у Pavilion — HD */
export const screenOptionsFor = (
  options: { value: string; label: string; os: string }[],
  gpu: string,
  os: string,
) => {
  const spec = DEVICE_SPECS[gpu];
  const byOs = options.filter((o) => o.os === 'any' || os === AUTO || o.os === os);
  if (!spec || !spec.screens.length) return byOs;
  const extra = spec.screens
    .filter((v) => !options.some((o) => o.value === v))
    .map((v) => {
      const [w, h] = v.split('x');
      return { value: v, label: `${w} × ${h}`, os: 'win' };
    });
  return [
    ...byOs.filter((o) => o.value === AUTO || spec.screens.includes(o.value)),
    ...extra,
  ];
};
